...
--update INGREDIENTEPRODUCCION set ingredienteverificable = 'NOVERIFICABLE' where idmetaproductoproduccion = 50;
--COMMIT
...
ALTER TABLE ORDENPRODUCCION ADD (ESTADOORDEN VARCHAR(20) NULL);
--ALTER TABLE ORDENPRODUCCION RENAME CANTIDADPRODUCIR to CANTIDADESPERADA;
--ALTER TABLE ORDENPRODUCCION RENAME TEORICOOBTENIDO TO CANTIDADPRODUCIDA;
