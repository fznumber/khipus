...
CREATE TABLE PRODUCTOORDEN(
  ...
  ,NOMBREPRODUTO VARCHAR(100) NOT NULL
  ,IDPRODUCTOPROCESADO NUMBER(24,0) NOT NULL  
  ,CONSTRAINT PK_PRODUCTOORDEN PRIMARY KEY(IDPRODUCTOORDEN)
);
--DROP TABLE PRODUCTOREPROCESADO
--ALTER TABLE PRODUCTOORDEN DROP CONSTRAINT FK_METAPROD_PRODORDE
...
ALTER TABLE PRODUCTOORDEN ADD CONSTRAINT FK_PRODPROCE_PRODORDE FOREIGN KEY (IDPRODUCTOPROCESADO)
REFERENCES PRODUCTOPROCESADO(IDPRODUCTOPROCESADO);
--COMMIT
