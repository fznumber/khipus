...
import com.encens.khipus.action.dashboard.MissingGraphic;
...
import com.encens.khipus.dashboard.module.employees.MissingSql;
 ...
 * @version 3.2
 */
@Name("missingViewAction")
@Scope(ScopeType.EVENT)
public class MissingViewAction extends GraphicViewAction<MissingGraphic> {

    private Integer businessUnitId;
    private CostCenter costCenter;
    private OrganizationalUnit organizationalUnit;
    private MissingSql sql;

    @Create
    public void initialize() {
        setGraphic(new MissingGraphic());
        graphic.setCategoryAxisLabel(MessageUtils.getMessage("Reports.missing.categoryAxisLabel"));
        graphic.setValueAxisLabel(MessageUtils.getMessage("Reports.missing.valueAxisLabel"));
