...
/**
 * Action to generate laboral professor payroll summary report
 * @author
 * @version 3.4
 */
@Name("laboralProfessorPayrollSummaryReportAction")
@Restrict("#{s:hasPermission('LABORALPROFESSORPAYROLLSUMMARYREPORT','VIEW')}")
public class LaboralProfessorPayrollSummaryReportAction extends GenericReportAction {
    ...
    public void generateReport() {
        ...
        super.generateReport("laboralProfessorSummaryReport", "/employees/reports/laboralProfessorPayrollSummaryReport.jrxml", PageFormat.LETTER, PageOrientation.LANDSCAPE, MessageUtils.getMessage("Reports.laboralProfessorPayrollSummary.title"), params);
    }
    ...
    protected String getEjbql() {
        ...
        String ejbql = "SELECT DISTINCT " +
                ...
                " LEFT JOIN generatedPayroll.fiscalProfessorPayrollList fiscalProfessorPayroll" +
                " LEFT JOIN fiscalProfessorPayroll.costCenter costCenter" +
    ...
    @Create
    public void init() {
        restrictions = new String[]{"generatedPayroll.generatedPayrollType=#{laboralProfessorPayrollSummaryReportAction.generatedPayrollType}"};
    ...
    private Map getReportParamsInfo() {
        ...
        paramMap.put("groupTitleParam", MessageUtils.getMessage("Reports.laboralProfessorPayrollSummary.groupTitle", MessageUtils.getMessage(getMonth().getResourceKey()), getGestion().getYear()));
        paramMap.put("groupFooterTitleParam", MessageUtils.getMessage("Reports.laboralProfessorPayrollSummary.groupFooterTitle", MessageUtils.getMessage(getMonth().getResourceKey()), getGestion().getYear()));
