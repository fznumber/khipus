 ...
 * @version 3.4
 */
@Name("academicPayrollSummaryReportAction")
@Restrict("#{s:hasPermission('ACADEMICPAYROLLSUMMARYREPORT','VIEW')}")
public class AcademicPayrollSummaryReportAction extends GenericReportAction {
    ...
    public void generateReport() {
        ...
        super.generateReport("academicSummaryReport", "/employees/reports/academicPayrollSummaryReport.jrxml", PageFormat.LETTER, PageOrientation.LANDSCAPE, MessageUtils.getMessage("Reports.academicPayrollSummary.title"), params);
    }
    ...
    protected String getEjbql() {
        ...
        String ejbql = "SELECT DISTINCT " +
                ...
                " LEFT JOIN generatedPayroll.generalPayrollList generalPayroll" +
    ...
    @Create
    public void init() {
        restrictions = new String[]{"generatedPayroll.generatedPayrollType=#{academicPayrollSummaryReportAction.generatedPayrollType}"};
    ...
    private Map getReportParamsInfo() {
        ...
        paramMap.put("groupTitleParam", MessageUtils.getMessage("Reports.academicPayrollSummary.groupTitle", MessageUtils.getMessage(getMonth().getResourceKey()), getGestion().getYear()));
        paramMap.put("groupFooterTitleParam", MessageUtils.getMessage("Reports.academicPayrollSummary.groupFooterTitle", MessageUtils.getMessage(getMonth().getResourceKey()), getGestion().getYear()));
