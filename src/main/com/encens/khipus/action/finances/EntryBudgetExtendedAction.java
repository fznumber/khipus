 ...
 * @version 2.8
 */
@Name("entryBudgetExtendedAction")
@Scope(ScopeType.PAGE)
public class EntryBudgetExtendedAction extends DashboardObjectAction<BudgetExtended> {
    ...
    protected void initializeFactory() {
        factory = new ComponentFactory<BudgetExtended, SumTotalizer<BudgetExtended>>(
                new BudgetExtendedSqlQuery("-1", "presupuestoingreso", "ENTRY", "BURDEN"),
