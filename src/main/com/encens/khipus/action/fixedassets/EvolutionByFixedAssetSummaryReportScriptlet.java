...
/**
 * Encens S.R.L.
 * This class implements the fixed asset evolution summary by fixed asset report scriptlet, his gets the positive movements and negative movements
 * and depreciations for the fixedAssetGroups.
 *
 * @author
 * @version 2.25
 */
public class EvolutionByFixedAssetSummaryReportScriptlet extends JRDefaultScriptlet {
    ...
    private EvolutionByFixedAssetSummaryReportAction evolutionByFixedAssetSummaryReportAction =
            (EvolutionByFixedAssetSummaryReportAction) Component.getInstance("evolutionByFixedAssetSummaryReportAction");
    ...
    public void beforeDetailEval() throws JRScriptletException {
        ...
        Date initDate = evolutionByFixedAssetSummaryReportAction.getInitDateRange();
        Date endDate = evolutionByFixedAssetSummaryReportAction.getEndDateRange();
        if (initDate == null) {
        ...
        CurrencyValuesContainer movementsSumValues = fixedAssetMovementService.getMovementsSumByFixedAssetUpTo(fixedAssetGroupPk, fixedAssetSubGroupPk, fixedAssetId, initDate);
        ...
        //Get depreciations
        CurrencyValuesContainer depreciationsContainer = fixedAssetDepreciationRecordService.getDepreciationAmountForFixedAssetUpTo(fixedAssetGroupPk,
        ...
        CurrencyValuesContainer positiveMovementsSumValues = fixedAssetMovementService.getMovementsSumByFixedAsset(fixedAssetGroupPk, fixedAssetSubGroupPk,
                fixedAssetId, initDate, endDate, FixedAssetMovementTypeEnum.ALT);
        ...
        CurrencyValuesContainer negativeMovementsSumValues = fixedAssetMovementService.getMovementsSumByFixedAsset(fixedAssetGroupPk, fixedAssetSubGroupPk,
                fixedAssetId, initDate, endDate, FixedAssetMovementTypeEnum.BAJ);
