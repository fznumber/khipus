...
/**
 * Encens S.R.L.
 * This class implements the fixed asset evolution summary by group report scriptlet, his gets the positive movements and negative movements
 * and depreciations for the fixedAssetGroups.
 *
 * @author
 * @version 2.25
 */
public class EvolutionByGroupSummaryReportScriptlet extends JRDefaultScriptlet {
    ...
    private EvolutionByGroupSummaryReportAction evolutionByGroupSummaryReportAction =
            (EvolutionByGroupSummaryReportAction) Component.getInstance("evolutionByGroupSummaryReportAction");

    /**
     * Gets some calculations (depreciation amount, movements amounts) for groups
     *
    ...
    public void beforeDetailEval() throws JRScriptletException {
        ...
        Date initDate = evolutionByGroupSummaryReportAction.getInitDateRange();
        Date endDate = evolutionByGroupSummaryReportAction.getEndDateRange();
        if (initDate == null) {
        ...
        CurrencyValuesContainer movementsSumValues = fixedAssetMovementService.getMovementsSumUpTo(fixedAssetGroupPk, initDate);
        ...
        //Get depreciations
        CurrencyValuesContainer depreciationsContainer = fixedAssetDepreciationRecordService.getDepreciationAmountForGroupUpTo(fixedAssetGroupPk,
                initDate);
        ...
        CurrencyValuesContainer positiveMovementsSumValues = fixedAssetMovementService.getMovementsSum(fixedAssetGroupPk, initDate, endDate, FixedAssetMovementTypeEnum.ALT);
        ...
        CurrencyValuesContainer negativeMovementsSumValues = fixedAssetMovementService.getMovementsSum(fixedAssetGroupPk, initDate, endDate, FixedAssetMovementTypeEnum.BAJ);
