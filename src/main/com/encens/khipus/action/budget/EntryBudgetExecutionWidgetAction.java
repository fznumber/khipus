 ...
 * @version 2.26
 */
@Name("entryBudgetExecutionWidgetAction")
@Scope(ScopeType.EVENT)
public class EntryBudgetExecutionWidgetAction extends PieWidgetViewAction<PieGraphic> {
    public static final String XML_WIDGET_ID = "11";
    ...
    protected void setFilters(SqlQuery sqlQuery) {
        ...
        ((BudgetExecutionSql) sqlQuery).setClassifierType(ClassifierType.BURDEN);
    }
