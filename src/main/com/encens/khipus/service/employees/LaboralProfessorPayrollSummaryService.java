 ...
 */
@Local
public interface LaboralProfessorPayrollSummaryService {
    ...
    GeneratedPayroll getPreviousMonthGeneratedPayroll(JobCategory jobCategory, Gestion gestion, Month month, Long businessUnitId);
