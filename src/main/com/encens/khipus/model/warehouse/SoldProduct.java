...
@NamedQueries({
        ...
        @NamedQuery(name = "SoldProduct.findByInvoiceNumberWithoutCutCheese",
                query = "select soldProduct from SoldProduct soldProduct where soldProduct.invoiceNumber =:invoiceNumber and soldProduct.companyNumber =:companyNumber and soldProduct.productItemCode <> :codCutCheese and soldProduct.productItemCode <> :codCheeseEDAM"),
        ...
        @NamedQuery(name = "SoldProduct.findByProductItemWithouCutCheese",
                query = "select distinct(soldProduct.productItem) from SoldProduct soldProduct where soldProduct.invoiceNumber =:invoiceNumber and soldProduct.companyNumber =:companyNumber and soldProduct.productItemCode <> :codCutCheese and soldProduct.productItemCode <> :codCheeseEDAM"),
