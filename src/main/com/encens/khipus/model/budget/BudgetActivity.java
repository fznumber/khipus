 ...
 * @author
 */
@TableGenerator(schema = com.encens.khipus.util.Constants.KHIPUS_SCHEMA, name = "BudgetActivity.tableGenerator",
        table = com.encens.khipus.util.Constants.SEQUENCE_TABLE_NAME,
        pkColumnName = com.encens.khipus.util.Constants.SEQUENCE_TABLE_PK_COLUMN_NAME,
        valueColumnName = com.encens.khipus.util.Constants.SEQUENCE_TABLE_VALUE_COLUMN_NAME,
        pkColumnValue = "actividad",
        allocationSize = com.encens.khipus.util.Constants.SEQUENCE_ALLOCATION_SIZE)
@Entity
@Filter(name = com.encens.khipus.util.Constants.COMPANY_FILTER_NAME)
@EntityListeners({CompanyListener.class, UpperCaseStringListener.class})
@Table(schema = com.encens.khipus.util.Constants.KHIPUS_SCHEMA, name = "actividad", uniqueConstraints = {
        @UniqueConstraint(columnNames = {"idprograma", "nombre"}),
        @UniqueConstraint(columnNames = {"idprograma", "codigo"})
})
public class BudgetActivity implements BaseModel {

    @Id
    @Column(name = "idactividad", nullable = false)
    @GeneratedValue(strategy = GenerationType.TABLE, generator = "BudgetActivity.tableGenerator")
    private Long id;
    ...
    @JoinColumn(name = "idprograma", nullable = false, updatable = false)
    @NotNull
